...
import edu.ezip.ing1.pds.requests.InsertAllEvenementsClientRequest;
...
public class InsertEvenement {
    ...
    public static void sendValue(String requestOrder, Object object) throws IOException, SQLException, InterruptedException {
        ...
        final InsertAllEvenementsClientRequest insert = new InsertAllEvenementsClientRequest (
                networkConfig,
                birthdate++, request, null, requestBytes);
        insert.join();
}}